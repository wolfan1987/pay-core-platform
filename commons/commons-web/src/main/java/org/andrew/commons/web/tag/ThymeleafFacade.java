...
public final class ThymeleafFacade {
     ...
     * getRawValue。
     */
    public static String getRawValue(
        final IProcessableElementTag element, final AttributeName attributeName) {
     ...
     */
    public static String getRawValue(
        final IProcessableElementTag element, final String attributeName) {
        notNull(element, "element must not be null");
     ...
     * evaluateExpression。
     */
    public static Object evaluateExpression(ITemplateContext arguments, String expression)
        ...
        final IStandardExpression evaluableExpression = parser.parseExpression(
     ...
     * evaluateAsIterable。
     */
    public static List<Object> evaluateAsIterable(ITemplateContext arguments, String rawValue)
        throws TemplateProcessingException {
        notNull(arguments, "arguments must not be null");
     ...
     */
    public static List<Object> evaluateAsIterableOrRawValue(
        ITemplateContext arguments, String rawValue) {
        notNull(arguments, "arguments must not be null");
        notEmpty(rawValue, "rawValue must not be empty");
     ...
     */
    public static List<String> evaluateAsStringsWithDelimiter(
        ITemplateContext arguments, String rawValue, String delimiter) {
        notNull(arguments, "arguments must not be null");
        notEmpty(rawValue, "rawValue must not be empty");

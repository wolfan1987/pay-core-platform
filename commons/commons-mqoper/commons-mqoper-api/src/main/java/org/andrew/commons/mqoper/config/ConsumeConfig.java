...
public class ConsumeConfig extends  AbstractConfig {
     ...
     */
    protected boolean  isPullOrPush=true;
    /**
     * 在客户端拉模式时，要指定brokerName
     */
    protected  String   borkerName = null;
    /**
     * 拉取消费时，是否要进行定时拉取
     */
    protected  boolean  isSchedulePull = false;
    /**
     * 拉取消费时指定队列ID
     */
    protected  int  pullQueueId = 0;
    /**
     * 拉取消费时，一次消拉取多少条
     */
    protected  int  pullSize = 1;
    /**
     * 消费订阅的主题
     */
     ...
     */
    protected  boolean   isFilterTags = false;
    /**
     * 过滤时实现的的java源文件
     */
    protected  String   filterJavaFile = "";
    /**
     * 过滤时实现的java源文件的class文件（含包名)
     */
    protected  String   filterClassFile = "";
    /**
     * 消息模式：0=集群模式，1=广播模式
     */
    protected  int  messageModel = 0;
